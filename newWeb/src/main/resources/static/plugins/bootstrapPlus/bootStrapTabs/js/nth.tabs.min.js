        ...
        var b = {
            init: function () {
                ...
                h.find(".nav-tabs li a").each(function () {
                    i.push({id: a(this).attr("href"), title: a(this).children("span").html()})
                });
                return i
            }, addTab: function (j) {
                var k = [];
                ...
                h.find(".nav-tabs li:gt(0)").not('[class="active"]').remove();
                h.find(".tab-content div:gt(0)").not('[class="tab-pane active"]').remove();
                return b
            }, delAllTab: function () {
                h.find(".nav-tabs li:gt(0)").remove();
                h.find(".tab-content div:gt(0)").remove();
                h.find(".nav-tabs li:eq(0)").addClass("active");
                h.find(".tab-content div:eq(0)").addClass("active");
                return b
